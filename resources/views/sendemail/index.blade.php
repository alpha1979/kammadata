                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <form method="POST" action="{{route('sendemail.store')}}" >
                            @csrf
                            {{--Checking if any error on validation will message will appear --}}
                            @if($errors->any())
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-success btn-sm"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
